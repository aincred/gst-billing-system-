...
// // import { Plus, Trash2, Printer, FileText, Settings, Users, Building, List, Languages, Keyboard, Calculator, LogIn } from 'lucide-react';
...
// //                       <th className="p-3 font-medium w-24 text-center">SGST %</th>
// //                       <th className="p-3 font-medium w-24 text-center">CGST %</th>
...
// //                 <span>SGST: ₹{calculations.totalGstAmount.toFixed(2)}</span>
// //                 <span className="w-px h-4 bg-indigo-700"></span>
// //                 <span>Discount: -₹{discount.toFixed(2)}</span>
// //                 <span className="w-px h-4 bg-indigo-700"></span>
// //                 <span>Round Off: ₹{calculations.roundOff.toFixed(2)}</span>
// //               </div>
// //               <div className="text-xl font-bold flex items-center space-x-3 w-full md:w-auto justify-between md:justify-end">
